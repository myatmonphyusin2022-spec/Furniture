...
function Home() {
  const Title = ({
    ...
    <div className="mt-28 mb-10 flex flex-col px-4 md:flex-row md:justify-between md:px-0 lg:flex-row lg:justify-between">
      <h2 className="mb-4 text-2xl font-bold md:mb-0">{title}</h2>
      <Link to={href} className="text-muted-foreground font-semibold">
        {sideText}
      </Link>
    </div>
  );
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between">
        ...
        <div className="my-8 text-center lg:mt-16 lg:mb-0 lg:w-2/5 lg:text-left">
          <div className="space-y-8">
            <h4 className="text-own text-4xl font-extrabold lg:text-6xl">
              Modern Interior Design Studio
            </h4>

            <p className="text-own">
              Furniture is an essential component of any living space, providing
              functionality, comfort, and asthetic appeal.
            </p>
